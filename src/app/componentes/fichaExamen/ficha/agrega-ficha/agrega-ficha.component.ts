import { Component, OnInit, Inject } from '@angular/core';
  ...
  import { IFicha, IFichaCliente, IFichaDoctorSolicitante, IFichaEspecie, IFichaExamen, IFichaRaza, IFichaUsuarioAsignado } from '@app/modelo/ficha-interface';
...
export class AgregaFichaComponent implements OnInit {
  ...
  grabar(examenEncontrado,UsuarioIngresado, flag,codigoInterno){
      if (flag!=0){
