...
export class ExamenComponent implements OnInit {
 ...
 // id: string;
  ...
  displayedColumns: string[] = ['index', 'Codigo', 'descripcion', 'sigla', 'precio', 'opciones'];
...
actualiza(id: string, codigoExamen: string, descripcion: string, sigla: string, precio: number) {
    this.datoPar = {
      _id: id,
      codigoExamen,
      descripcion,
...
consulta(id: string, codigoExamen: string, descripcion: string, sigla: string, precio: number) {
    this.datoPar = {
      _id: id,
      codigoExamen,
      descripcion,
...
elimina(id: string,  codigoExamen: string, descripcion: string, sigla: string, precio: number) {
    this.datoPar = {
      _id: id,
      codigoExamen,
      descripcion,
